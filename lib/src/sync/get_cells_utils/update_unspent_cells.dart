...
Future<UpdateCellsResult> updateUnspentCells(String lockHash, CellsResultBean cellsResultBean,
  ...
  if ((targetBlockNumber - syncedBlockNumber) * 50 > cellsResultBean.cells.length) {
    ...
    newCellsResult.cells.addAll(await getCurrentIndexCellsWithTargetNumber(
        lockHash, syncedBlockNumber, targetBlockNumber, apiClient, syncProcess));
