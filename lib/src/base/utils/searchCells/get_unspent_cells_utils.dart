...
Future<List<CellBean>> getWholeHDAllCells(HDCore hdCore, int targetBlockNumber) async {
...
Future<List<CellBean>> getCurrentIndexCells(HDCore hdCore, int startBlockNumber, int targetBlockNumber) async {
  List<CellBean> cells = List();
