...
main() {
  test('from create', () {
    ...
    WalletCore walletCore = WalletCore(HDCoreConfig(privateKey, 0, 0), 'test/store/cells.txt');
  ...
  test('from store', () {
    Uint8List privateKey =
        intToBytes(toBigInt(remove0x('e79f3207ea4980b7fed79956d5934249ceac4751a4fae01a0f7c4a96884bc4e3')));
    WalletCore walletCore = WalletCore(HDCoreConfig(privateKey, 1, 1), 'test/store/cells.txt');
    expect(walletCore.unusedReceiveWallet.getAddress(Network.TestNet),
